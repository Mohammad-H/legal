...
$(function() {
    ...
    // custom
    var table_basic_one = $('.datatable-button-html5-columns').DataTable({
        fixedHeader: true
    });
    ...
    toggleType.onchange = function() {
        if(toggleType.checked) {
            ...
            // Add offset to all
            table_basic_one.fixedHeader.headerOffset($('.navbar-fixed-top').height());
            ...
            table_basic_one.fixedHeader.headerOffset(0);
